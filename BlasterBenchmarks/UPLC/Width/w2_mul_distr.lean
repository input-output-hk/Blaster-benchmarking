...
theorem w2_mul_distr : ∀ (x y z : Int), Uplc.run (.lam "x" (.lam "y" (.lam "z" (.app (.app (.bltn .Mul) (.var "x")) (.app (.app (.bltn .Add) (.var "y")) (.var "z")))))) [(.con x), (.con y), (.con z)] 41 = some (x * (y + z)) := by sorry
