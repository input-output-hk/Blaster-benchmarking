...
theorem d_sum_256 : Uplc.run ((List.range 256).foldl (fun acc k => Term.app (Term.app (Term.bltn Bltn.Add) acc) (Term.con (Int.ofNat (k+1)))) (Term.con 0)) [] 2148 = some 32896 := by sorry
