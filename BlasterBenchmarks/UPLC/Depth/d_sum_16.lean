...
theorem d_sum_16 : Uplc.run ((List.range 16).foldl (fun acc k => Term.app (Term.app (Term.bltn Bltn.Add) acc) (Term.con (Int.ofNat (k+1)))) (Term.con 0)) [] 228 = some 136 := by sorry
