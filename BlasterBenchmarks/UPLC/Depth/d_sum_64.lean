...
theorem d_sum_64 : Uplc.run ((List.range 64).foldl (fun acc k => Term.app (Term.app (Term.bltn Bltn.Add) acc) (Term.con (Int.ofNat (k+1)))) (Term.con 0)) [] 612 = some 2080 := by sorry
