...
theorem verifyElem_test1 :
  executeVerifier 42 [1, 2, 3, 4, 5] = some 0 := by sorry
theorem verifyElem_test2 :
  executeVerifier 7 [9, 8, 7, 6, 5] = some 1 := by sorry
theorem verifyElem_test3 :
  executeVerifier 0 [] = some 0 := by sorry
